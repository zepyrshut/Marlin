...
* Temperatura máxima de 250 grados en modo normal y 280 grados en modo temperatuas altas.
...
* Guía de uso y más información en [Zepyr's Hut](https://zepyrshut.com/antes-de-la-primera-impresion-de-anycubic-kossel), se recomienda leer la guía si no tienes muy claro lo que hay que hacer hacer. Se recomienda leer para todo el mundo.
...
* Configurar PID del cartucho calefactor `#define DEFAULT_Kp`, `#define DEFAULT_Ki`,`#define DEFAULT_Kd`. Sólo en caso de inestablidad de temperaturas.
* Configurar PID de la base caliente `#define DEFAULT_bedKp`, `#define DEFAULT_bedKi`,`#define DEFAULT_bedKd`. Sólo en caso de inestabilidad de temperaturas.
...
* Experimental: descomentar `#if ENABLED(HIGH_TEMP)` si se desea lograr temperaturas por encima de los 245 grados. Usar con precaución y saber lo que se hace. No recomendable usar en  fusores clonados. Sólo para el V5 y V6 original.
